...
Пoлезни връзки:
- [ShatterLine Blog - Naive Bayes Classifier](http://shatterline.com/blog/2013/09/12/not-so-naive-classification-with-the-naive-bayes-classifier/)
- [GeeksforGeeks - Naive Bayes Classifier](https://www.geeksforgeeks.org/naive-bayes-classifiers/)
